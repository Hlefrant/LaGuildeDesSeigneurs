 ...
 */
final class Version20191105095901 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE characters ADD player_id INT NOT NULL, CHANGE modification modification DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE characters DROP player_id, CHANGE modification modification DATETIME DEFAULT NULL');
    }
}
